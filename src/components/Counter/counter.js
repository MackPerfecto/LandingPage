...
class Counter extends Component {
    state = {
        counters : [
            { icon : "pe-7s-like2", title : "SUCCESSFUL PROJECTS", postfix : "+", end : 180 },
            { icon : "pe-7s-light", title : "PROJECT IDEAS", postfix : "+", end : 270 },
            { icon : "pe-7s-smile", title : "SATISFIED CLIENTS", postfix : "+", end : 170 },
            { icon : "pe-7s-star", title : "AWARD WON", postfix : "", end : 5 },
        ],
    }
    render() {
        return (
